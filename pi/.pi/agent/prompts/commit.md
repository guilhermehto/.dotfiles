...
Steps:
1. Run `git status` to see what is staged. If nothing is staged, stop and tell me — do **not** stage anything yourself.
...
Rules:
- Do not stage, unstage, amend, or push anything.
- Do not include co-author trailers, emojis, or marketing language.
- If the staged diff mixes unrelated concerns, stop and tell me — suggest splitting before committing.
