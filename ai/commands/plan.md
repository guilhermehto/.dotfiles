---
description: Generate a local implementation plan — ground in the code, align via catechism, then write a phased .scriptorum/ plan with rich-context checkbox steps and tracked status
