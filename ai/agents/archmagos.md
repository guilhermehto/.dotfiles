...
- **Don't impose codebase walkthroughs.** If you find yourself spelunking more than 2–3 files to answer, stop and ask whether the user actually wants `explorator` instead.
